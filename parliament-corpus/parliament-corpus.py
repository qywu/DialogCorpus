...
dataset_name = "parliament-corpus"

raw_data = read_json("full/parliament-corpus/utterances.json")
...
# this dataset contain question answer pair, which is always 1 turn. It seems useful
#all_dialogue = delete_one_turn_dialogue(all_dialogue)

all_dialogue = safe_clean_all_dialogue(all_dialogue[::10])
